...
const TaxCalculator: React.FC = () => {
  ...
  const [vatType, setVatType] = useState<"inclusive" | "exclusive">(
    "exclusive"
  );
    ...
    <div className="min-h-screen" style={{ backgroundColor: "#F5F5F5" }}>
      <div className="bg-[#faf9ff] overflow-hidden w-full max-w-[1440px] relative">
        ...
        <div className="text-center mb-8">
          <p className="text-gray-600 text-lg max-w-2xl mx-auto">
            Calculate your Income Tax, VAT, Withholding Tax, and Turnover Tax
                      ...
                      <div className="flex space-x-4">
                        <label className="flex items-center">
                          <input
                            ...
                            onChange={(e) =>
                              setVatType(e.target.value as "exclusive")
                            }
                            className="mr-2"
                          />
                          VAT Exclusive
                        ...
                        <label className="flex items-center">
                          <input
                            ...
                            onChange={(e) =>
                              setVatType(e.target.value as "inclusive")
                            }
                            className="mr-2"
                          />
                          VAT Inclusive
                    ...
                    <div className="bg-gray-50 rounded-lg p-6">
                      ...
                      <div className="space-y-3">
                        <div className="flex justify-between">
                          ...
                          <span className="font-medium">
                            {formatCurrency(parseFloat(vatAmount))}
                          </span>
                        </div>
                        <div className="flex justify-between">
                          <span className="text-gray-600">VAT Amount:</span>
                          <span className="font-medium text-red-600">
                            {formatCurrency(vatResult.taxAmount)}
                          </span>
                        </div>
                        <div className="flex justify-between">
                          <span className="text-gray-600">
                          ...
                          <span className="font-medium text-green-600">
                            {formatCurrency(vatResult.afterTaxAmount)}
                          </span>
                        </div>
                        <div className="flex justify-between">
                          <span className="text-gray-600">VAT Rate:</span>
                          <span className="font-medium">
                            {vatResult.effectiveRate}%
                          </span>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="bg-gray-50 rounded-lg p-6">
                      ...
                      <div className="space-y-3">
                        <div className="flex justify-between">
                          ...
                          <span className="font-medium">
                            {formatCurrency(parseFloat(whtAmount))}
                          </span>
                        </div>
                        <div className="flex justify-between">
                          <span className="text-gray-600">WHT Amount:</span>
                          <span className="font-medium text-red-600">
                            {formatCurrency(whtResult.taxAmount)}
                          </span>
                        </div>
                        <div className="flex justify-between">
                          <span className="text-gray-600">Net Payment:</span>
                          <span className="font-medium text-green-600">
                            {formatCurrency(whtResult.afterTaxAmount)}
                          </span>
                        </div>
                        <div className="flex justify-between">
                          <span className="text-gray-600">WHT Rate:</span>
                          <span className="font-medium">
                            {whtResult.effectiveRate}%
                          </span>
                        </div>
                      </div>
                    </div>
                  ...
                  <div>
                    ...
                    <div className="mb-6 p-4 bg-blue-50 rounded-lg">
                      <p className="text-sm text-gray-700">
                        <strong>Note:</strong> Turnover tax is typically 1% of
                        gross turnover for small businesses. This is a
                        simplified tax system for small enterprises.
                      </p>
                    </div>
      ...
      <div className="flex items-center justify-center mb-8">
        <button
          ...
          className="w-[300px] py-3 px-6 text-white font-medium rounded-lg hover:shadow-lg transition-all duration-200"
          style={{ backgroundColor: "#5A57FF" }}
        >
          Pay Tax
        </button>
